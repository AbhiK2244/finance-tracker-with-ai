...
export async function createTransaction(data) {
  try {
    ...
    // find the account where you want to create the transaction
...
// server action for ai receipt scanner
...
export async function updateTransaction(id, data) {
  try {
    ...
    //get the original transaction to calculate the balance change
